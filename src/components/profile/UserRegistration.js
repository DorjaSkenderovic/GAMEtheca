...
export default function UserRegistration() {
  ...
  function signupButton() {
    document
      .getElementById("user_options-forms")
      ...
      <div className="user_options-container">
        <div className="user_options-text">
          <div className="user_options-unregistered">
            ...
            <button
              className="user_unregistered-signup button_style"
              id="signup-button"
          ...
          <div className="user_options-registered">
            ...
            <button
              className="user_registered-login button_style"
              id="login-button"
              onClick={loginButton}
            >
              Login
          ...
          <div className="user_forms-login">
            ...
            <form className="forms_form" onSubmit={login}>
              ...
              <div className="forms_buttons">
                <button
                  type="button"
                  className="forms_buttons-forgot button_style"
                >
                  Forgot password?
                </button>
                <input
                  type="submit"
                  value="Log In"
                  className="forms_buttons-action input_style"
                />
              </div>
            </form>
          </div>
            ...
            <form className="forms_form" onSubmit={register}>
              ...
              <div className="forms_buttons">
                <input
                  type="submit"
                  value="Sign up"
                  className="forms_buttons-action signup input_style"
                />
              </div>
            </form>
          </div>
